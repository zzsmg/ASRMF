...
class mymodel(BaseModel):
    def __init__(self, opt):
        ...
        if self.is_train:
            ...
            if train_opt['feature_weight'] > 0:
                ...
                self.l_fea_w = train_opt['feature_weight']  # 1
            else:
            ...
            self.l_gan_w = train_opt['gan_weight']  # 5e-3
    ...
    def optimize_parameters(self, step):
        ...
        if step % self.D_update_ratio == 0 and step > self.D_init_iters:
            ...
            l_g_gan = self.l_gan_w * self.cri_gan(pred_g_fake, True)  # 5e-3 * cri_gan
            l_g_cls = self.l_gan_w * self.cri_ce(cls_g_fake, self.var_cat)  # 5e-3 * cri_ce
            loss_gan_cls = l_g_gan + l_g_cls
            l_g_total += l_g_gan
            l_g_total += l_g_cls
